...
- **A6 — Submodule working-tree state makes the repo unforkable, and is
  ...
  default**, opt out with `--no-with-submodules` — proven feasible and offline
  across eight cells, needing no verification exemption. Impact: medium-high
  for submodule users. Type: correctness fix, feature-shaped by owner decision.
...
- [~] [P02-TS06] A6 adversarial verification (incl. Codex): CONFIRMED-WITH-CORRECTIONS 2026-08-17 — matrix 1 reproduced the rollback across four dirty shapes and refuted the "unforkable by default" breadth (staged gitlink advance already forks); matrix 2 proved identical carry is feasible and offline across eight cells. Register entry rewritten. **Codex second lens still pending**; see the [design doc](../docs/superpowers/plans/2026-08-17-p02-a6-dirty-submodules.md)
- [ ] [P02-T06] A6 fix per process — carry submodules identically by default, `--with-submodules` / `--no-with-submodules` (owner decision 2026-08-17); plan in the [design doc](../docs/superpowers/plans/2026-08-17-p02-a6-dirty-submodules.md)
