...
- [-] [P01-T51] Pin the branch-derived candidate between the confirmation dry run and the real run — **WILL NOT FIX (owner decision 2026-08-18).** `P02-TS08` absorbed this narrower candidate-name drift into A8's full confirmation-boundary analysis, and `P02-T08` declined the stable plan-token remedy as too complex for this CLI's needs. The accepted confirmation-boundary limitation is recorded in [P02](P02-agent-fork-fault-remediation.md).
