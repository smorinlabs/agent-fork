...
builders and shell-quoting boundary, E1–E3 were rerun together against the real CLIs:
`3 passed in 24.23s`. The locked templates and conclusions below remain unchanged.
