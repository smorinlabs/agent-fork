...
| T-VER-51 | PR #67 Copilot/CodeRabbit review — when recursive submodule verification is the only failing rung, `submodule-content-match` is the one structured primary check | baseline | F | live | PR #67 review |
